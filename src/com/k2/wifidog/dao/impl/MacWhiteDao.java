...
public class MacWhiteDao implements Dao<MacWhite>{
	...
	public List<MacWhite> find() throws SQLException {
		return (List<MacWhite>) qr.query("select * from rule_macwhite", new BeanListHandler(MacBlack.class));
	}
	...
	public List<MacWhite> findByDeviceToken(String device_token) throws SQLException{
		return (List<MacWhite>) qr.query("select * from rule_macwhite where ap_id =(select ap_id from ap where dev_md5=?)", 
